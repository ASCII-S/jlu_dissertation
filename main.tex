...
% oneside：单面打印
% openany:章节从任意页码开始
\documentclass[UTF8,openany,oneside,fontset=fandol]{jlutex}
\setCJKfamilyfont{myLishu}[AutoFakeBold=true, Path=./, Extension=.TTF]{SIMLI} 
\newcommand{\lishu}{\CJKfamily{myLishu}}
% 如果的确须要使脚注按页编号的话，可以去掉后面 footmisc 包的注释。
% 注意：在启用此设定的情况下，可能要多编译一次以产生正确的脚注编号。
\usepackage[perpage]{footmisc}

% \usepackage{CJK} % 与 xeCJK 冲突，XeLaTeX 编译时不需要此包
...
\jlutexinfo{
	...
	level = {硕士},
	DegreeCategory = {专业学位}, %学术学位 或 专业学位
	securitylevel = {公\hskip 0.15cm 开},
	cuniversity = {吉林大学}, euniversity = {Jilin University},
	cthesisname = {硕士学位论文},ethesisname = {Master Thesis},
	ctitle = {吉林大学学位论文LaTeX模板示例}, etitle = {Sample of LaTexAa Template for Jilin University Dissertation And the Rest is to Test},
	...
	date = {2020年3月},
	school = {计算机科学与技术学院},
	cmajor = {工程硕士}, emajor = {Master of Engineering}, %专业学位时填写类别（如"工程硕士"），学术学位时填写专业名称
	direction = {计算机技术}, %专业学位时填写领域/方向，学术学位时填写研究方向
...
%对号和错号
% \usepackage{amssymb}% http://ctan.org/pkg/amssymb  % 与newtxmath冲突，已注释
